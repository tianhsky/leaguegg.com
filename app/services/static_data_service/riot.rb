module StaticDataService
  ...
  module Riot
    ...
    def self.fetch_champions(region='na')
      ...
      url = "http://ddragon.leagueoflegends.com/cdn/5.24.1/data/en_US/champion.json"
    ...
    def self.fetch_maps(region='na')
      ...
      url = "http://ddragon.leagueoflegends.com/cdn/5.24.1/data/en_US/map.json"
      resp = RiotAPI.get(url, region)
    end
    ...
    def self.fetch_masteries(region='na')
      ...
      url = "http://ddragon.leagueoflegends.com/cdn/5.24.1/data/en_US/mastery.json"
      resp = RiotAPI.get(url, region)
    end
